...
import (
	...
	applyconfigurationlonghornv1beta2 "kubeall.io/api-server/pkg/generated/longhorn/applyconfiguration/longhorn/v1beta2"
	scheme "kubeall.io/api-server/pkg/generated/longhorn/clientset/versioned/scheme"
...
type BackingImageManagerInterface interface {
	...
	Apply(ctx context.Context, backingImageManager *applyconfigurationlonghornv1beta2.BackingImageManagerApplyConfiguration, opts v1.ApplyOptions) (result *longhornv1beta2.BackingImageManager, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, backingImageManager *applyconfigurationlonghornv1beta2.BackingImageManagerApplyConfiguration, opts v1.ApplyOptions) (result *longhornv1beta2.BackingImageManager, err error)
	BackingImageManagerExpansion
}

// backingImageManagers implements BackingImageManagerInterface
type backingImageManagers struct {
	*gentype.ClientWithListAndApply[*longhornv1beta2.BackingImageManager, *longhornv1beta2.BackingImageManagerList, *applyconfigurationlonghornv1beta2.BackingImageManagerApplyConfiguration]
}
...
func newBackingImageManagers(c *LonghornV1beta2Client, namespace string) *backingImageManagers {
	return &backingImageManagers{
		gentype.NewClientWithListAndApply[*longhornv1beta2.BackingImageManager, *longhornv1beta2.BackingImageManagerList, *applyconfigurationlonghornv1beta2.BackingImageManagerApplyConfiguration](
