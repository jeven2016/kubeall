...
type SnapshotInterface interface {
	...
	Apply(ctx context.Context, snapshot *applyconfigurationlonghornv1beta2.SnapshotApplyConfiguration, opts v1.ApplyOptions) (result *longhornv1beta2.Snapshot, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, snapshot *applyconfigurationlonghornv1beta2.SnapshotApplyConfiguration, opts v1.ApplyOptions) (result *longhornv1beta2.Snapshot, err error)
	SnapshotExpansion
}

// snapshots implements SnapshotInterface
type snapshots struct {
	*gentype.ClientWithListAndApply[*longhornv1beta2.Snapshot, *longhornv1beta2.SnapshotList, *applyconfigurationlonghornv1beta2.SnapshotApplyConfiguration]
}

// newSnapshots returns a Snapshots
func newSnapshots(c *LonghornV1beta2Client, namespace string) *snapshots {
	return &snapshots{
		gentype.NewClientWithListAndApply[*longhornv1beta2.Snapshot, *longhornv1beta2.SnapshotList, *applyconfigurationlonghornv1beta2.SnapshotApplyConfiguration](
			"snapshots",
			c.RESTClient(),
