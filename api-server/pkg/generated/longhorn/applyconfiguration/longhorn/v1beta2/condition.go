...
func (b *ConditionApplyConfiguration) WithStatus(value longhornv1beta2.ConditionStatus) *ConditionApplyConfiguration {
	b.Status = &value
	return b
}
...
func (b *ConditionApplyConfiguration) WithLastProbeTime(value string) *ConditionApplyConfiguration {
